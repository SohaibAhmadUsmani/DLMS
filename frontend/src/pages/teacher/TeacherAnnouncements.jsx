...
export default function TeacherAnnouncements() {
  ...
  const { data, isLoading } = useGetAnnouncementsQuery({ include_archived: false })
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">Create and manage announcements for your students.</p>
        </div>
